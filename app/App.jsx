            ...
            <div id='map-wrapper' className='row' style={{height: this.state.dimensions.heights.map + "px"}}>
              <div className='columns twelve full-height'>
                <LeafletMap ref="map" location={loc} zoom={zoom} mapEvents={mapEvents} mapOptions={mapOptions}>
                  <CartoTileLayer
                    src="http://ec2-54-174-39-10.compute-1.amazonaws.com/richmond-terrain/{z}/{x}/{y}.png"
                  ...
                  <TileLayer src="http://ec2-54-174-39-10.compute-1.amazonaws.com/richmond-terrain/{z}/{x}/{y}.png" attribution="&copy; <a href='http://osm.org/copyright'>OpenStreetMap</a> contributors | Designed by <a href='http://stamen.com?from=richmondatlas'>Stamen Design</a>" />
