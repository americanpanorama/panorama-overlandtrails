    ...
    return (
      <div className="flow-map-component">
        ...
        <LeafletMap ref="flowmap" location={loc} zoom={zoom} mapEvents={evts} mapOptions={mapOptions}>
          ...
          <TileLayer src="http://sm.mapstack.stamen.com/openterrain_2163/{z}/{x}/{y}.png" attribution="&copy; <a href='http://osm.org/copyright'>OpenStreetMap</a> contributors | Designed by <a href='http://stamen.com?from=richmondatlas'>Stamen Design</a>" />
